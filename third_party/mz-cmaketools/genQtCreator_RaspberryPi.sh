...
#######################################################################
#
#  Configure Codeblocks/QtCreator project files to compile for RaspberryPi
...
BUILD_DIR="QtCreator_RaspberryPi"
RELEASE_DIR="Release_$BUILD_DIR"
GENERATOR="CodeBlocks - Unix Makefiles"
TARGET="QtCreator / RaspberryPi"
...
function make_debug {
	...
	cmake	-D CMAKE_BUILD_TYPE=Debug \
			-D CMAKE_TOOLCHAIN_FILE="$BASE_DIR/$SCRIPT_DIR/RaspberryPi.cmake" \
			-G"$GENERATOR" \
			$BASE_DIR/
}
