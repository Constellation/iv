...
class MonoIC : public IC {
 public:
  ...
  void LoadCompile(Assembler* as, JSObject* global, railgun::Code* code, Symbol name) {
  ...
  void LoadRepatch(Assembler* as, Map* map, uint32_t offset) {
